...
class Map(object):
    ...
    def on_EVENT_LBUTTONDOWN(self,event, x, y, flags, param):
        ...
        if event == cv2.EVENT_LBUTTONDOWN:
            ...
            cv2.circle(self.drawMap,point (x, y), 1, (255, 0, 0), thickness=-1)
...
# /////////////////////////////////////////////
    def Route(self,point,v):
        ...
        arr1=[]
        arr2=[]
        # for i in range(len(tuple(a))):
        #     arr1.append(a[i])
        #     for j in range(len(tuple(b))):
        #         arr2.append(b[j])
        #         if i==j:
        #             # print(i==j)
        #             cv2.line(self.drawMap,tuple(arr1),tuple(arr2),(0,0,255),2)
        # print("arr1:",arr1)
        # print("arr2:",arr2) 
        cv2.line(self.drawMap,tuple(b),tuple(a),(0,0,255),2)
...
class RRTStar(object):
    tree = []
    def __init__(self,map,step,speed = 500):
        self.step = step
        self.map = map
    ...
    def nearToNew(self, new):
        ...
        for item in self.tree:
            ...
            if costToNew < self.step * 2:
                ...
                # print("nearTonew是:",nearTonew)
                # print("nearCost是:",nearCost)
    ...
    def drawRoute(self, point):
        ...
        while True:
            ...
            #     for j in range(len(routePoint[i])):
            #         # print(routePoint[i])
            if c.loc == start:
                break
        return routePoint
...
if __name__ == "__main__":
    ...
    T = []
    while t0 < 10:
        map = Map("E:\picture\pic1\heibai1.png")
        time1 = time.time()
        end = [450, 250]
        start = [400, 10]
